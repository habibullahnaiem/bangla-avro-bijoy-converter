...
(async () => {
  ...
  const tests = [
    ...
    ["রেল", "†ij", "টেক্সট-শুরুতে এ-কার † (মাত্রাহীন) — বয়বহারকারী-নিশ্চিত"],
    ["এখন রেল এখন", "GLb †ij GLb", "প্রতিটি নতুন শব্দের শুরুতে † এবং একই শব্দের মাঝে ‡ — mid-word মাত্রা অক্ষুণ্ণ"],
    ["শ্রেণি", "†kÖwY" , "শ্র+ে+ণী (টেক্সট-শুরুতে †)"],
  ];
  let pass = 0;
