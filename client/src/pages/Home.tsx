...
import {
  ...
  const EXAMPLE_TEXT = `প্রাপক:
সম্পাদক মহোদয়
দৈনিক পত্রিকা কার্যালয়
ঢাকা।

তারিখ: ১৪ আগস্ট, ২০২৬

বিষয়: বাংলা ফন্ট রূপান্তর সম্বন্ধে জানানো — সুতন্নী এমজে ॥

সম্পাদক মহোদয়,

সাবিনয়ে জানাচ্ছি, বিভাগের সকল নথি-পত্র নতুন টাইপোগ্রাফি নীতিমালা (২০২৬) অনুযায়ী রূপান্তর করা হচ্ছে। নবম তল্লায় (ফ্লোর নং ৯) কার্যালয় চালু হয়েছে। শিক্ষার্থীদের জন্য দুইটি সেশন (সকাল ও বিকেল) নির্ধারণ করা হয়েছে।

উল্লেখযোগ্য বিষয়াদি: (ক) ন্থ, ল্ল, য়, ড়, ঢ় যুক্তবর্ণ অক্ষুণ্ণ থাকে; (খ) দাঁড়ি (।) সোজা আসে, ম-ফলার মতো নয়; (গ) কোট ও ড্যাশ ভুল গ্লিফ হয় না। The Times — ইংরেজি পার্ট 2pt ছোট দেখায়।

বিস্তারিত পরিচ্ছেদ ৩.৪ (পৃ. ৪৫) দ্রষ্টব্য।

বিনীত নিবেদন এই, অনুগ্রহ করে বিষয়টি নথিভুক্ত করবেন।
