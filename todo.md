...
# সক্রিয়: নির্দিষ্ট বিজয় বাইটে ঋ-কারের ফাঁক
- [x] `K„wlwfwËK` ও `K…wlwfwËK` তুলনা: দুটি আলাদা SutonnyMJ byte form; ব্যবহারকারী-যাচাইকৃত `…` form-টি সঠিক glyph placement দেয় এবং Bijoy→Unicode round-trip-এ একই বাংলা পাঠ ফেরত আসে
- [x] `„`-কে ফাঁক-সৃষ্টিকারী legacy R-kar byte এবং `…`-কে canonical R-kar byte হিসেবে নিশ্চিত করা; standalone ellipsis DOCX normalization পৃথক রাখা হয়েছে
- [x] CSS overlay ছাড়া safe canonicalization প্রয়োগ: generated R-kar `„` থেকে `…`; rich preview-র gap-producing override অপসারণ
- [x] কপি, TXT/DOCX, Bengali quote, e-kar, r-fola এবং Footnote/Endnote রিগ্রেশন চালানো; নতুন DOCX assertion-এ `কৃষিভিত্তিক` অবশ্যই `K…wlwfwËK` হয়
- [ ] বাস্তব SutonnyMJ output যাচাই, checkpoint এবং ব্যবহারকারীকে ফল জানানো
