...
# নতুন: ঋ-কার (ৃ) সরে যাচ্ছে
- [ ] user report নথিভূক্ত করা: দারির পর/বা সাধারণ পরিস্থিতিতে ঋ-কার সরে যাচ্ছে/উপরে/নিচে বসছে
- [ ] rich preview renderer-এ ঋ-কারের বর্তমান optical correction পর্যালোচনা
- [x] glyph স্তরে root cause নিৰ্ধাৰণ: SutonnyMJ U+201E marker-এর advance ≈0.1px (টাইপোগ্রাফি সঠিক); ব্রাউজারে inline-block token-এ marker গ্লিফ বেসলাইন-এর নিচে দোলে — Dari (`|`)-র পরে মার্কার বাম-নিচে সরে যায়। current `left:-0.1em/top:-0.04em` shift যথেষ্ট নয়। ফিক্স: পরবর্তী বেস-গ্লিফ token-এর ওপর marker-কে abs-overlay করে (top ~0.2em, left ~0.12em) বসানো; base token-এর spacing অপরিবর্তিত।
- [ ] কেবল CSS optical correction প্রয়োগ; কনভাৰ্টার বাইট, ফুটনোট/এন্ডনোট অক্ষুণ্ণ রাখা
- [ ] full regression (core, quotes, e-kar, r-fola, DOCX) ও desktop/mobile screenshot যাচাই
- [ ] checkpoint ও ব্যবহারকারীকে জানানো
